...
void options::CreatePanel_NMEA( size_t parent, int border_size, int group_item_spacing, wxSize small_button_size )
{
    ...
    sbSizerGeneral = new wxStaticBoxSizer( new wxStaticBox( m_pNMEAForm, wxID_ANY, _("常规") ), wxVERTICAL );
    ...
    m_cbFilterSogCog = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("NMEA航向和航速数据过滤器"), wxDefaultPosition, wxDefaultSize, 0 );
    m_cbFilterSogCog->SetValue( g_bfilter_cogsog );
    bSizer171->Add( m_cbFilterSogCog, 0, wxALL, 5 );

    m_stFilterSec = new wxStaticText( m_pNMEAForm, wxID_ANY, _("过滤周期 (秒)"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    int cb_space = 2;
    m_cbNMEADebug = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("显示NMEA调试窗口"), wxDefaultPosition, wxDefaultSize, 0 );
    m_cbNMEADebug->SetValue(NMEALogWindow::Get().Active());
    bSizer161->Add( m_cbNMEADebug, 0, wxALL, cb_space );

    m_cbFurunoGP3X = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("GP3X上传"), wxDefaultPosition, wxDefaultSize, 0 );
    m_cbFurunoGP3X->SetValue(g_GPS_Ident == _T("FurunoGP3X"));
    bSizer161->Add( m_cbFurunoGP3X, 0, wxALL, cb_space );

    m_cbGarminUploadHost = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("使用Garmin GRMN (Host)格式上传"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticBoxSizer* sbSizerLB= new wxStaticBoxSizer( new wxStaticBox( m_pNMEAForm, wxID_ANY, _("数据连接") ), wxVERTICAL );
    ...
    m_buttonAdd = new wxButton( m_pNMEAForm, wxID_ANY, _("添加链接"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer18->Add( m_buttonAdd, 0, wxALL, 5 );

    m_buttonRemove = new wxButton( m_pNMEAForm, wxID_ANY, _("移除链接"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    sbSizerConnectionProps = new wxStaticBoxSizer( new wxStaticBox( m_pNMEAForm, wxID_ANY, _("属性") ), wxVERTICAL );

    wxBoxSizer* bSizer15;
    bSizer15 = new wxBoxSizer( wxHORIZONTAL );

    m_rbTypeSerial = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("串口"), wxDefaultPosition, wxDefaultSize, 0 );
    m_rbTypeSerial->SetValue( true );
//----------------------------------------------------------------------------
    bSizer15->Add( m_rbTypeSerial, 0, wxALL, 5 );
//----------------------------------------------------------hitwh wht 隐藏串口(不再从串口接受AIS信息)
    m_rbTypeNet = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("网络"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_stNetProto = new wxStaticText( m_pNMEAForm, wxID_ANY, _("协议"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stNetProto->Wrap( -1 );
    ...
    m_stNetAddr = new wxStaticText( m_pNMEAForm, wxID_ANY, _("地址"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stNetAddr->Wrap( -1 );
    ...
    m_stNetPort = new wxStaticText( m_pNMEAForm, wxID_ANY, _("数据端口"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stNetPort->Wrap( -1 );
    ...
    m_stSerPort = new wxStaticText( m_pNMEAForm, wxID_ANY, _("数据端口"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stSerPort->Wrap( -1 );
    fgSizer1->Add( m_stSerPort, 0, wxALL, 5 );//---wht
    ...
    m_stSerBaudrate = new wxStaticText( m_pNMEAForm, wxID_ANY, _("波特率"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stSerBaudrate->Wrap( -1 );
    fgSizer1->Add( m_stSerBaudrate, 0, wxALL, 5 );//---wht
    ...
    m_stSerProtocol = new wxStaticText( m_pNMEAForm, wxID_ANY, _("协议"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stSerProtocol->Wrap( -1 );
    fgSizer1->Add( m_stSerProtocol, 0, wxALL, 5 );//----wht
    ...
    fgSizer1->Add( m_choiceSerialProtocol, 1, wxEXPAND|wxTOP, 5 );//----wht

    m_stPriority = new wxStaticText( m_pNMEAForm, wxID_ANY, _("优先性"), wxDefaultPosition, wxDefaultSize, 0 );
    m_stPriority->Wrap( -1 );
    ...
    m_cbCheckCRC = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("控制检查总和"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_cbGarminHost = new wxCheckBox( m_pNMEAForm, wxID_ANY, _("使用Garmin (GRMN)模式进行输入"), wxDefaultPosition, wxDefaultSize, 0 );
    m_cbGarminHost->SetValue(false);
    fgSizer5->Add( m_cbGarminHost, 0, wxALL, 5 );//-----wht
    ...
    sbSizerInFilter = new wxStaticBoxSizer( new wxStaticBox( m_pNMEAForm, wxID_ANY, _("输入过滤") ), wxVERTICAL );

    wxBoxSizer* bSizer9;
    bSizer9 = new wxBoxSizer( wxHORIZONTAL );

    m_rbIAccept = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("只接受语句"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    bSizer9->Add( m_rbIAccept, 0, wxALL, 5 );

    m_rbIIgnore = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("忽略语句"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    sbSizerOutFilter = new wxStaticBoxSizer( new wxStaticBox( m_pNMEAForm, wxID_ANY, _("输出忽略") ), wxVERTICAL );

    wxBoxSizer* bSizer10;
    bSizer10 = new wxBoxSizer( wxHORIZONTAL );

    m_rbOAccept = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("发送语句"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    bSizer10->Add( m_rbOAccept, 0, wxALL, 5 );

    m_rbOIgnore = new wxRadioButton( m_pNMEAForm, wxID_ANY, _("终止语句"), wxDefaultPosition, wxDefaultSize, 0 );
...
{
    itemPanelShip = AddPage( parent, _("本船") );

    ownShip = new wxBoxSizer( wxVERTICAL );
    itemPanelShip->SetSizer( ownShip );

    //      OwnShip Display options
    wxStaticBox* osdBox = new wxStaticBox( itemPanelShip, wxID_ANY, _("显示设置") );
    ...
    wxStaticText *pStatic_OSCOG_Predictor = new wxStaticText( itemPanelShip, wxID_ANY, _("对地航向预测长度(最小值)") );
    ...
    wxStaticText *iconTypeTxt = new wxStaticText( itemPanelShip, wxID_ANY, _("船舶图标类型") );
    dispOptionsGrid->Add( iconTypeTxt, 0 );

    wxString iconTypes[] = { _("默认"), _("真是比例Bitmap"), _("真是比例Vector") };
    ...
    realSizes->Add( new wxStaticText( itemPanelShip, wxID_ANY, _("总长度(米)") ), 1, wxALIGN_LEFT );
    m_pOSLength = new wxTextCtrl( itemPanelShip, 1 );
    realSizes->Add( m_pOSLength, 1, wxALIGN_RIGHT | wxALL, group_item_spacing );

    realSizes->Add( new wxStaticText( itemPanelShip, wxID_ANY, _("总宽度(米)") ), 1, wxALIGN_LEFT );
    m_pOSWidth = new wxTextCtrl( itemPanelShip, wxID_ANY );
    realSizes->Add( m_pOSWidth, 1, wxALIGN_RIGHT | wxALL, group_item_spacing );

    realSizes->Add( new wxStaticText( itemPanelShip, wxID_ANY, _("船头GPS偏移量(米)") ), 1, wxALIGN_LEFT );
    ...
    realSizes->Add( new wxStaticText( itemPanelShip, wxID_ANY, _("船中部GPS偏移量(米)") ), 1, wxALIGN_LEFT );
    ...
    realSizes->Add( new wxStaticText( itemPanelShip, wxID_ANY, _("最小屏幕(毫米)") ), 1, wxALIGN_LEFT );
    ...
    wxStaticText *rrTxt = new wxStaticText( itemPanelShip, wxID_ANY, _("显示距离圈") );
    ...
    wxStaticText* distanceText = new wxStaticText( itemPanelShip, wxID_STATIC, _("环间距离") );
    ...
    wxStaticText* unitText = new wxStaticText( itemPanelShip, wxID_STATIC, _("距离单位") );
    radarGrid->Add( unitText, 1, wxEXPAND | wxALL, group_item_spacing );

    wxString pDistUnitsStrings[] = { _("海里"), _("千米") };
    ...
    radarGrid->Add( m_itemRadarRingsUnits, 0, wxALIGN_RIGHT | wxALL, border_size );
     ...
     //  Tracks
    wxStaticBox* trackText = new wxStaticBox( itemPanelShip, wxID_ANY, _("轨迹") );
    wxStaticBoxSizer* trackSizer = new wxStaticBoxSizer( trackText, wxVERTICAL );
    ownShip->Add( trackSizer, 0, wxGROW | wxALL, border_size );

    pTrackDaily = new wxCheckBox( itemPanelShip, ID_DAILYCHECKBOX, _("自动日追踪") );
    trackSizer->Add( pTrackDaily, 1, wxALL, border_size );

    pTrackHighlite = new wxCheckBox( itemPanelShip, ID_TRACKHILITE, _("高亮显示航迹") );
    ...
    wxStaticText* tpText = new wxStaticText( itemPanelShip, wxID_STATIC, _("追踪精度") );
    pTrackGrid->Add( tpText, 1, wxEXPAND | wxALL, group_item_spacing );

    wxString trackAlt[] = { _("低"), _("中"), _("高") };
    ...
    //  Routes
    wxStaticBox* routeText = new wxStaticBox( itemPanelShip, wxID_ANY, _("航线") );
...
{
    wxScrolledWindow *chartPanelWin = AddPage( m_pageCharts, _("海图文件") );

    chartPanel = new wxBoxSizer( wxVERTICAL );
    chartPanelWin->SetSizer( chartPanel );

    wxStaticBox* loadedBox = new wxStaticBox( chartPanelWin, wxID_ANY, _("路径") );
    ...
    wxButton* addBtn = new wxButton( chartPanelWin, ID_BUTTONADD, _("添加路径...") );
    cmdButtonSizer->Add( addBtn, 1, wxALL | wxEXPAND, group_item_spacing );

    m_removeBtn = new wxButton( chartPanelWin, ID_BUTTONDELETE, _("移除所选项") );
...
void options::CreatePanel_Advanced( size_t parent, int border_size, int group_item_spacing,
                                        wxSize small_button_size )
{
    m_ChartDisplayPage = AddPage( parent, _("高级") );
...
//    m_ChartDisplayPage->SetSizer( itemBoxSizerUI );
    ...
    itemBoxSizerUI->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("海图显示") ), groupLabelFlags );
    wxBoxSizer* boxCharts = new wxBoxSizer( wxVERTICAL );
    itemBoxSizerUI->Add( boxCharts, groupInputFlags );

    pSkewComp = new wxCheckBox( m_ChartDisplayPage, ID_SKEWCOMPBOX, _("以北方向上方式显示光栅倾斜海图") );
    boxCharts->Add( pSkewComp, inputFlags );
    
    pFullScreenQuilt = new wxCheckBox( m_ChartDisplayPage, ID_FULLSCREENQUILT, _("关闭全屏拼接") );
    ...
    itemBoxSizerUI->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("船头向上刷新周期") ), labelFlags );
    ...
    pCOGUPFilterRow->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("秒") ), inputFlags );
    ...
    // Control Options
    itemBoxSizerUI->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("控制") ), groupLabelFlags );
    wxBoxSizer* boxCtrls = new wxBoxSizer( wxVERTICAL );
    itemBoxSizerUI->Add( boxCtrls, groupInputFlags );

    pWayPointPreventDragging = new wxCheckBox( m_ChartDisplayPage, ID_DRAGGINGCHECKBOX, _("锁定航路点 (除非可以看到航路点属性对话框)") );
    pWayPointPreventDragging->SetValue( FALSE );
    boxCtrls->Add( pWayPointPreventDragging, inputFlags );

    pConfirmObjectDeletion = new wxCheckBox( m_ChartDisplayPage, ID_DELETECHECKBOX, _("删除航迹和航线时弹出确定框") );
    ...
    //  Display size/DPI
    itemBoxSizerUI->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("P物理屏幕宽度") ), labelFlags );
    wxBoxSizer *pDPIRow = new wxBoxSizer( wxHORIZONTAL );
    itemBoxSizerUI->Add( pDPIRow, 0, wxEXPAND );
    
    pRBSizeAuto = new wxRadioButton( m_ChartDisplayPage, wxID_ANY, _("自动") );
    pDPIRow->Add( pRBSizeAuto, inputFlags );
    pDPIRow->AddSpacer( 10 );
    pRBSizeManual = new wxRadioButton( m_ChartDisplayPage, ID_SIZEMANUALRADIOBUTTON, _("手动:") );
    ...
    // OpenGL Options
    itemBoxSizerUI->Add( new wxStaticText( m_ChartDisplayPage, wxID_ANY, _("图形") ), labelFlags );
    wxBoxSizer* OpenGLSizer = new wxBoxSizer( wxHORIZONTAL );
    itemBoxSizerUI->Add( OpenGLSizer, 0, 0, 0 );

    pOpenGL = new wxCheckBox( m_ChartDisplayPage, ID_OPENGLBOX, _("使用图形加速功能 (OpenGL)") );
    OpenGLSizer->Add( pOpenGL, inputFlags );
    pOpenGL->Enable(!g_bdisable_opengl);

    wxButton *bOpenGL = new wxButton( m_ChartDisplayPage, ID_OPENGLOPTIONS, _("设置...") );
...
void options::CreatePanel_VectorCharts( size_t parent, int border_size, int group_item_spacing,
        wxSize small_button_size )
{
    ps57Ctl = AddPage( parent, _("矢量海图显示") );
    ...
    // dislay category
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("显示分类")), labelFlags );
    wxString pDispCatStrings[] = { _("基本"), _("标准"), _("全部显示"), _("船员标准") };
    ...
    // display options
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("显示")), groupLabelFlags );

    wxBoxSizer* miscSizer = new wxBoxSizer( wxVERTICAL );
    optionsColumn->Add( miscSizer, groupInputFlags );

    pCheck_SOUNDG = new wxCheckBox( ps57Ctl, ID_SOUNDGCHECKBOX, _("水深点") );
    pCheck_SOUNDG->SetValue( FALSE );
    miscSizer->Add( pCheck_SOUNDG, inputFlags );

    pCheck_META = new wxCheckBox( ps57Ctl, ID_METACHECKBOX, _("海图信息对象") );
    pCheck_META->SetValue( FALSE );
    miscSizer->Add( pCheck_META, inputFlags );

    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("浮标/灯")), groupLabelFlags );

    wxBoxSizer* lightSizer = new wxBoxSizer( wxVERTICAL );
    optionsColumn->Add( lightSizer, groupInputFlags );
    
    pCheck_ATONTEXT = new wxCheckBox( ps57Ctl, ID_ATONTEXTCHECKBOX, _("浮标/灯标签") );
    pCheck_ATONTEXT->SetValue( FALSE );
    lightSizer->Add( pCheck_ATONTEXT, inputFlags );

    pCheck_LDISTEXT = new wxCheckBox( ps57Ctl, ID_LDISTEXTCHECKBOX, _("灯描述") );
    pCheck_LDISTEXT->SetValue( FALSE );
    lightSizer->Add( pCheck_LDISTEXT, inputFlags );

    pCheck_XLSECTTEXT = new wxCheckBox( ps57Ctl, ID_LDISTEXTCHECKBOX, _("已拓展照明区") );
    pCheck_XLSECTTEXT->SetValue( FALSE );
    lightSizer->Add( pCheck_XLSECTTEXT, inputFlags );

    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("海图文本")), groupLabelFlags );

    wxBoxSizer* textSizer = new wxBoxSizer( wxVERTICAL );
    optionsColumn->Add( textSizer, groupInputFlags );

    pCheck_NATIONALTEXT = new wxCheckBox( ps57Ctl, ID_NATIONALTEXTCHECKBOX, _("海图上显示国家") );
    pCheck_NATIONALTEXT->SetValue( FALSE );
    textSizer->Add( pCheck_NATIONALTEXT, inputFlags );

    pCheck_SHOWIMPTEXT = new wxCheckBox( ps57Ctl, ID_IMPTEXTCHECKBOX, _("只显示重要文本信息") );
    pCheck_SHOWIMPTEXT->SetValue( FALSE );
    textSizer->Add( pCheck_SHOWIMPTEXT, inputFlags );

    pCheck_DECLTEXT = new wxCheckBox( ps57Ctl, ID_DECLTEXTCHECKBOX, _("清理文本") );
    pCheck_DECLTEXT->SetValue( FALSE );
    textSizer->Add( pCheck_DECLTEXT, inputFlags );

    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("海图细节")), labelFlags );
    pCheck_SCAMIN = new wxCheckBox( ps57Ctl, ID_SCAMINCHECKBOX, _("小比例尺时减少信息显示") );
    ...
    // graphics options
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("海图显示风格")), labelFlags );
    wxString pPointStyleStrings[] = { _("纸质海图"), _("Simplified"), };
    ...
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("边界")), labelFlags );
    wxString pBoundStyleStrings[] = { _("普通版本"), _("符号化版本"), };
    ...
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("颜色")), labelFlags );
    wxString pColorNumStrings[] = { _("2 种颜色"), _("4 种颜色"), };
    ...
    // depth options
    optionsColumn->Add( new wxStaticText( ps57Ctl, wxID_ANY, _("浅滩深度") ), labelFlags );
    ...
    optionsColumn->Add( new wxStaticText( ps57Ctl, wxID_ANY, _("安全深度") ), labelFlags );
    ...
    optionsColumn->Add( new wxStaticText( ps57Ctl, wxID_ANY, _("深层深度") ), labelFlags );
...
#ifdef USE_S57
    optionsColumn->Add( new wxStaticText(ps57Ctl, wxID_ANY, _("CM93精细程度")), labelFlags );
...
//    cm93Sizer->SetSizeHints(cm93DetailBox);
    ...
    wxStaticBox* marinersBox = new wxStaticBox( ps57Ctl, wxID_ANY, _("船员标准") );
    ...
    itemButtonSelectList = new wxButton( ps57Ctl, ID_SELECTLIST, _("选择全部") );
    btnRow->Add( itemButtonSelectList, 1, wxALL | wxEXPAND, group_item_spacing );
    itemButtonClearList = new wxButton( ps57Ctl, ID_CLEARLIST, _("取消全部选择") );
...
void options::CreatePanel_TidesCurrents( size_t parent, int border_size, int group_item_spacing,
        wxSize small_button_size )
{
    wxScrolledWindow *tcPanel = AddPage( parent, _("潮汐&&潮流") );

    wxBoxSizer* mainHBoxSizer = new wxBoxSizer( wxVERTICAL );
    tcPanel->SetSizer( mainHBoxSizer );

    wxStaticBox *tcBox = new wxStaticBox( tcPanel, wxID_ANY, _("有效数据" ));
    ...
    wxButton *insertButton = new wxButton( tcPanel, ID_TCDATAADD, _("添加数据集...") );
    wxButton *removeButton = new wxButton( tcPanel, ID_TCDATADEL, _("移除所选项") );
        ...
        wxSize small_button_size )
{
	...
	((wxNotebook *)m_groupsPage)->AddPage( groupsPanel, _("海图组") );
...
void ChartGroupsUI::CompletePanel( void )
{
    ...
    wxStaticText *allChartsLabel = new wxStaticText( this, wxID_ANY, _("所有可利用的海图") );
    ...
    m_pAddButton = new wxButton( this, ID_GROUPINSERTDIR, _("添加") );
    m_pAddButton->Disable();
    m_pRemoveButton = new wxButton( this, ID_GROUPREMOVEDIR, _("移除海图") );
    ...
    wxStaticText *groupsLabel = new wxStaticText( this, wxID_ANY, _("海图组") );
    ...
    m_GroupNB->AddPage( allActiveGroup, _("全部海图") );
    ...
    m_pNewGroupButton = new wxButton( this, ID_GROUPNEWGROUP, _("新的海图...") );
    m_pDeleteGroupButton = new wxButton( this, ID_GROUPDELETEGROUP, _("删除") );
...
void options::CreatePanel_Display( size_t parent, int border_size, int group_item_spacing,
        wxSize small_button_size )
{
    pDisplayPanel = AddPage( parent, _("常规") );
...
//    pDisplayPanel->SetSizer( generalSizer );
    ...
    // Nav Mode
    generalSizer->Add( new wxStaticText( pDisplayPanel, wxID_ANY, _("航行模式") ), groupLabelFlags );
    ...
    pCBNorthUp = new wxRadioButton( pDisplayPanel, wxID_ANY, _("北方朝上") );
    rowOrientation->Add( pCBNorthUp, inputFlags );
    pCBCourseUp = new wxRadioButton( pDisplayPanel, ID_COURSEUPCHECKBOX, _("船头朝上") );
    rowOrientation->Add( pCBCourseUp, wxSizerFlags(0).Align(wxALIGN_CENTRE_VERTICAL).Border(wxLEFT, group_item_spacing*2) );

    pCBLookAhead = new wxCheckBox( pDisplayPanel, ID_CHECK_LOOKAHEAD, _("朝前看模式") );
    ...
    // Control Options
    generalSizer->Add( new wxStaticText( pDisplayPanel, wxID_ANY, _("海图显示") ), groupLabelFlags );
    wxBoxSizer* boxCharts = new wxBoxSizer( wxVERTICAL );
    generalSizer->Add( boxCharts, groupInputFlags );

    pCDOQuilting = new wxCheckBox( pDisplayPanel, ID_QUILTCHECKBOX1, _("启动海图拼接") );
    boxCharts->Add( pCDOQuilting, inputFlags );

    pPreserveScale = new wxCheckBox( pDisplayPanel, ID_PRESERVECHECKBOX, _("海图切换时保留原比例尺") );
    ...
    // Control Options
    generalSizer->Add( new wxStaticText( pDisplayPanel, wxID_ANY, _("控制") ), groupLabelFlags );
    wxBoxSizer* boxCtrls = new wxBoxSizer( wxVERTICAL );
    generalSizer->Add( boxCtrls, groupInputFlags );
    
    pSmoothPanZoom = new wxCheckBox( pDisplayPanel, ID_SMOOTHPANZOOMBOX, _("稳定缩放或平移") );
    boxCtrls->Add( pSmoothPanZoom, inputFlags );
    
    pEnableZoomToCursor = new wxCheckBox( pDisplayPanel, ID_ZTCCHECKBOX, _("对光标处进行放缩") );
    ...
    // Display Options
    generalSizer->Add( new wxStaticText( pDisplayPanel, wxID_ANY, _("显示设置") ), groupLabelFlags );
    wxBoxSizer* boxDisp = new wxBoxSizer( wxVERTICAL );
    generalSizer->Add( boxDisp, groupInputFlags );

    pSDisplayGrid = new wxCheckBox( pDisplayPanel, ID_CHECK_DISPLAYGRID, _("显示网格") );
    boxDisp->Add( pSDisplayGrid, inputFlags );

    pCDOOutlines = new wxCheckBox( pDisplayPanel, ID_OUTLINECHECKBOX1, _("显示海图轮廓") );
    boxDisp->Add( pCDOOutlines, inputFlags );

    pSDepthUnits = new wxCheckBox( pDisplayPanel, ID_SHOWDEPTHUNITSBOX1, _("显示深度单位") );
...
void options::CreatePanel_Units( size_t parent, int border_size, int group_item_spacing,
                                  wxSize small_button_size )
{
    wxScrolledWindow *panelUnits = AddPage( parent, _("单位") );
...
//    panelUnits->SetSizer( unitsSizer );
    ...
    // distance units
    unitsSizer->Add( new wxStaticText(panelUnits, wxID_ANY, _("距离")), labelFlags );
    wxString pDistanceFormats[] = { _("海里"), _("法定英里"), _("公里"), _("米") };
    ...
    // speed units
    unitsSizer->Add( new wxStaticText(panelUnits, wxID_ANY, _("速度")), labelFlags );
    wxString pSpeedFormats[] = { _("节"), _("英里/小时"), _("公里/小时"), _("米/秒") };
    ...
    // depth units
    //unitsSizer->Add( new wxStaticText(panelUnits, wxID_ANY, _("深度")), labelFlags );
    wxString pDepthUnitStrings[] = { _("英寸"), _("米"), _("英寻"), };
    ...
    // lat/long units
    unitsSizer->Add( new wxStaticText(panelUnits, wxID_ANY, _("经纬度")), labelFlags );
    wxString pSDMMFormats[] = { _("度, 分用小数形式表示"), _("度用小数形式表示"), _("度, 分, 秒") };
...
{
    wxScrolledWindow *panelAIS = AddPage( parent, _("AIS目标") );

    wxBoxSizer* aisSizer = new wxBoxSizer( wxVERTICAL );
    panelAIS->SetSizer( aisSizer );

    //      CPA Box
    wxStaticBox* itemStaticBoxCPA = new wxStaticBox( panelAIS, wxID_ANY, _("CPA计算") );
    ...
    m_pCheck_CPA_Warn = new wxCheckBox( panelAIS, -1, _("进行警告如果CPA小于(NMi)") );
    ...
    //      Lost Targets
    wxStaticBox* lostBox = new wxStaticBox( panelAIS, wxID_ANY, _("丢失目标") );
    ...
    m_pCheck_Mark_Lost = new wxCheckBox( panelAIS, -1, _("X分钟后标记目标为丢失 (min)") );
    ...
    //      Display
    wxStaticBox* displBox = new wxStaticBox( panelAIS, wxID_ANY, _("显示") );
    ...
    m_pCheck_Show_Moored = new wxCheckBox( panelAIS, -1, _("隐藏固定/停泊的目标, 目标最大速度(节）") );
    ...
    m_pCheck_Draw_Target_Size = new wxCheckBox( panelAIS, -1, _("显示AIS目标真实大小") );
    ...
    // Rollover
    wxStaticBox* rolloverBox = new wxStaticBox( panelAIS, wxID_ANY, _("拓展信息") );
    ...
    //      Alert Box
    wxStaticBox* alertBox = new wxStaticBox( panelAIS, wxID_ANY, _("CPA/TCPA警告") );
    ...
    wxButton *m_SelSound = new wxButton( panelAIS, ID_AISALERTSELECTSOUND,
            _("选择警告声音"), wxDefaultPosition, small_button_size, 0 );
    ...
    wxButton *m_pPlay_Sound = new wxButton( panelAIS, ID_AISALERTTESTSOUND,
            _("测试警告声音"), wxDefaultPosition, small_button_size, 0 );
...
//----------------------------------------------------------------------------------------------------------
  /*  wxStaticBox* itemFontStaticBox = new wxStaticBox( itemPanelFont, wxID_ANY,
    ...
    wxButton* itemFontChooseButton = new wxButton( itemPanelFont, ID_BUTTONFONTCHOOSE,
            _("选择字体..."), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxButton* itemFontColorButton = new wxButton( itemPanelFont, ID_BUTTONFONTCOLOR,
            _("选择字体颜色..."), wxDefaultPosition, wxDefaultSize, 0 );
...
//------------------------------------------------------------------------------------------------hitwh wht 隐藏更改字体功能
    ...
    wxStaticBox* miscOptionsBox = new wxStaticBox( itemPanelFont, wxID_ANY, _("界面选项") );
    ...
    pShowStatusBar = new wxCheckBox( itemPanelFont, ID_DEBUGCHECKBOX1, _("显示状态栏") );
    pShowStatusBar->SetValue( FALSE );
    miscOptions->Add( pShowStatusBar, 0, wxALL, border_size );

#ifndef __WXOSX__
    pShowMenuBar = new wxCheckBox( itemPanelFont, wxID_ANY, _("显示菜单栏") );
    pShowMenuBar->SetValue( TRUE );								//-----------------------------------hitwh wht 菜单栏永久显示
    miscOptions->Add( pShowMenuBar, 0, wxALL, border_size );
	//--------------------------------------------------------------------------------------
#endif

    pShowChartBar = new wxCheckBox( itemPanelFont, wxID_ANY, _("显示海图栏") );
    pShowChartBar->SetValue( g_bShowChartBar );
    miscOptions->Add( pShowChartBar, 0, wxALL, border_size );
    
    pShowCompassWin = new wxCheckBox( itemPanelFont, wxID_ANY, _("显示指南针/GPS状态窗口") );
    ...
    //pMobile = new wxCheckBox( itemPanelFont, ID_MOBILEBOX, _("启用触摸屏界面") );
...
void options::CreateControls()
{
    ...
    m_pageDisplay = CreatePanel( _("显示") );
    ...
    m_pageConnections = CreatePanel( _("链接") );
...
//-----------------------------------------------------------------------------------------
    //CreatePanel_MMSI( m_pageShips, border_size, group_item_spacing, m_small_button_size );//隐藏MMSI界面
 
//------------------------------------------------------------------------------------------------hitwh wht
    m_pageUI = CreatePanel( _("用户界面") );
    CreatePanel_UI( m_pageUI, border_size, group_item_spacing, m_small_button_size );
//------------------------------------------------------------------------------------------
   /* m_pagePlugins = CreatePanel( _("插件") );
...
ConnectionParams *options::CreateConnectionParamsFromSelectedItem()
{
    ...
    if (!(m_cbInput->GetValue() || m_cbOutput->GetValue())) {
        OCPNMessageBox( NULL, _("Data connection must be input, output or both"), _("海图信息"), wxICON_HAND );
    ...
    {
        OCPNMessageBox( NULL, _("You must select or enter the port..."), _("海图信息"), wxICON_HAND );
        return NULL;
    }
    ...
    //  TCP clients, GPSD and UDP output sockets require an address
        ...
        {
            OCPNMessageBox( NULL, _("你必须添加一个端口..."), _("海图信息"), wxICON_HAND );
            return NULL;
        }
        if (m_tNetAddress->GetValue() == wxEmptyString) {
            ...
            {
                OCPNMessageBox( NULL, _("你必须添加一个地址..."), _("海图信息"), wxICON_HAND );
                return NULL;
            } else {
...
void options::OnApplyClick( wxCommandEvent& event )
{
    ...
    if( m_pShipIconType->GetSelection() > 0 ) {
        ...
        if( ! msg.IsEmpty() ) {
            ...
            OCPNMessageBox( this, msg, _("海图软件信息"), wxICON_ERROR );
            ::wxEndBusyCursor();
...
// End of Connections page    
    ...
    g_btouch = false;//pMobile->GetValue();
...
//    g_bFullscreenToolbar = pFullScreenToolbar->GetValue();
    ...
    if( ps52plib ) {
        ...
        // Depths
        double dval;
        int depthUnit = 1;//pDepthUnitSelect->GetSelection();
        ...
        if( !m_bVisitLang ) {
            ...
            for( int it = 1; it < nLang; it++ ) {
                if( wxLocale::IsAvailable( lang_list[it] ) ) {
                    ...
                    ltest.AddCatalog( _T("海图") );
                    if( !ltest.IsLoaded( _T("海图") ) ) continue;
            ...
            plocale_def_lang->AddCatalog( _T("海图软件") );
...
SentenceListDlg::SentenceListDlg( FilterDirection dir, wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
    ...
    m_btnCheckAll = new wxButton( this, wxID_ANY, _("全选"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer18->Add( m_btnCheckAll, 0, wxALL, 5 );

    m_btnClearAll = new wxButton( this, wxID_ANY, _("全不选"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer18->Add( m_btnClearAll, 0, wxALL, 5 );

    bSizer18->AddSpacer(1);

    m_btnAdd = new wxButton( this, wxID_ANY, _("添加"), wxDefaultPosition, wxDefaultSize, 0 );
    bSizer18->Add( m_btnAdd, 0, wxALL, 5 );

    m_btnDel = new wxButton( this, wxID_ANY, _("删除"), wxDefaultPosition, wxDefaultSize, 0 );
...
void SentenceListDlg::SetType(int io, ListType type)
{
    ...
    switch (io)
    {
        ...
        default:
            if(type == WHITELIST)
                m_pclbBox->SetLabel(_("接收语句"));
            else
                m_pclbBox->SetLabel(_("忽略语句"));
            break;
        case 1:                 // output
            if(type == WHITELIST)
                m_pclbBox->SetLabel(_("发送语句"));
            else
                m_pclbBox->SetLabel(_("终止语句"));
            break;
    }
    Refresh();
}
