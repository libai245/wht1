...
RouteManagerDialog::RouteManagerDialog( wxWindow *parent )
{
    ...
    wxDialog::Create( parent, -1, wxString( _("航线 && 标记管理") ), wxDefaultPosition, wxDefaultSize,
            style );
...
void RouteManagerDialog::Create()
{
    ...
    m_pRouteListCtrl->InsertColumn( rmVISIBLE, _("显示"), wxLIST_FORMAT_LEFT, 40 );
    m_pRouteListCtrl->InsertColumn( rmROUTENAME, _("航线名称"), wxLIST_FORMAT_LEFT, 120 );
    ...
    btnRteProperties = new wxButton( m_pPanelRte, -1, _("&属性...") );
    ...
    btnRteActivate = new wxButton( m_pPanelRte, -1, _("&激活") );
    ...
    btnRteZoomto = new wxButton( m_pPanelRte, -1, _("&中心视图") );
    ...
    btnRteReverse = new wxButton( m_pPanelRte, -1, _("&倒转") );
    ...
    btnRteDelete = new wxButton( m_pPanelRte, -1, _("&删除") );
    ...
    btnRteSendToGPS = new wxButton( m_pPanelRte, -1, _("&发送到GPS") );
    ...
    btnRteDeleteAll = new wxButton( m_pPanelRte, -1, _("&删除全部") );
    ...
    m_pNotebook->AddPage( m_pPanelTrk, _("航迹") );
    ...
    m_pTrkListCtrl->InsertColumn( colTRKVISIBLE, _("显示"), wxLIST_FORMAT_LEFT, 40 );
    m_pTrkListCtrl->InsertColumn( colTRKNAME, _("航迹名称"), wxLIST_FORMAT_LEFT, 250 );
    m_pTrkListCtrl->InsertColumn( colTRKLENGTH, _("长度"), wxLIST_FORMAT_LEFT, 100 );

    wxBoxSizer *bsTrkButtons = new wxBoxSizer( wxVERTICAL );
    itemBoxSizer3->Add( bsTrkButtons, 0, wxALIGN_RIGHT );

    btnTrkNew = new wxButton( m_pPanelTrk, -1, _("&开启航迹") );
    ...
    btnTrkProperties = new wxButton( m_pPanelTrk, -1, _("&属性") );
    ...
    btnTrkDelete = new wxButton( m_pPanelTrk, -1, _("&删除") );
    ...
    btnTrkRouteFromTrack = new wxButton( m_pPanelTrk, -1, _("航迹上的航线") );
    ...
    btnTrkDeleteAll = new wxButton( m_pPanelTrk, -1, _("&删除全部") );
    ...
    m_pNotebook->AddPage( m_pPanelWpt, _("航点") );
    ...
    m_pWptListCtrl->InsertColumn( colWPTICON, _("图标"), wxLIST_FORMAT_LEFT, 44 );
    m_pWptListCtrl->InsertColumn( colWPTNAME, _("航点名称"), wxLIST_FORMAT_LEFT, 180 );
    m_pWptListCtrl->InsertColumn( colWPTDIST, _("距离本船的距离"), wxLIST_FORMAT_LEFT, 180 );

    wxBoxSizer *bsWptButtons = new wxBoxSizer( wxVERTICAL );
    itemBoxSizer4->Add( bsWptButtons, 0, wxALIGN_RIGHT );

    btnWptNew = new wxButton( m_pPanelWpt, -1, _("&新建") );
    ...
    btnWptProperties = new wxButton( m_pPanelWpt, -1, _("&属性") );
    ...
    btnWptZoomto = new wxButton( m_pPanelWpt, -1, _("&中心视图") );
    ...
    btnWptDelete = new wxButton( m_pPanelWpt, -1, _("&删除") );
    ...
    btnWptGoTo = new wxButton( m_pPanelWpt, -1, _("&航行至此处") );
    ...
    btnWptExport = new wxButton( m_pPanelWpt, -1, _("&保存...") );
    ...
    btnWptSendToGPS = new wxButton( m_pPanelWpt, -1, _("&发送到GPS") );
    ...
    btnWptDeleteAll = new wxButton( m_pPanelWpt, -1, _("删除全部") );
    ...
    btnImport = new wxButton( this, -1, _("&导入GPX...") );
...
*/
    btnExportViz = new wxButton( this, -1, _("导出所有可视...") );
    ...
    m_pNotebook->AddPage( m_pPanelLay, _("层") );
    ...
    m_pLayListCtrl->InsertColumn( colLAYNAME, _("层名称"), wxLIST_FORMAT_LEFT, 250 );
    m_pLayListCtrl->InsertColumn( colLAYITEMS, _("项目序号"), wxLIST_FORMAT_LEFT, 100 );

    wxBoxSizer *bsLayButtons = new wxBoxSizer( wxVERTICAL );
    itemBoxSizer7->Add( bsLayButtons, 0, wxALIGN_RIGHT );

    btnLayNew = new wxButton( m_pPanelLay, -1, _("临时层") );
    ...
    btnLayDelete = new wxButton( m_pPanelLay, -1, _("&删除") );
    ...
    btnLayToggleChart = new wxButton( m_pPanelLay, -1, _("在海图上显示") );
    ...
    btnLayToggleNames = new wxButton( m_pPanelLay, -1, _("显示WPT名称") );
    ...
    btnLayToggleListing = new wxButton( m_pPanelLay, -1, _("列出内容") );
...
void RouteManagerDialog::UpdateRteButtons()
{
    ...
    if( !g_pRouteMan->IsAnyRouteActive() ) {
        ...
        if( enable1 ) btnRteActivate->SetLabel( _("激活") );

    } else {
        if( enable1 ) {
            if( route && route->m_bRtIsActive ) {
                btnRteActivate->Enable( enable1 );
                btnRteActivate->SetLabel( _("使无效") );
            } else
...
void RouteManagerDialog::OnRteDeleteClick( wxCommandEvent &event )
{
    ...
    int answer = OCPNMessageBox( this, _("是否删除所选项目"), wxString( _("海图警告") ), wxYES_NO );
    if ( answer != wxID_YES )
        return;
...
{
    wxMenu menu;
    wxMenuItem* mergeItem = menu.Append( TRACK_MERGE, _("&合并选择的航迹") );
    mergeItem->Enable( m_pTrkListCtrl->GetSelectedItemCount() > 1 );
    wxMenuItem* cleanItem = menu.Append( TRACK_CLEAN, _("减少信息...") );
    cleanItem->Enable( m_pTrkListCtrl->GetSelectedItemCount() == 1 );
    wxMenuItem* copyItem = menu.Append( TRACK_COPY_TEXT, _("&复制为文本") );
    ...
    switch( event.GetId() ) {
        ...
        case TRACK_CLEAN: {
            ...
            wxString msg = wxString::Format( _("The amount of data used by the track\n was reduced by %d%%."),
                    reduction );
            OCPNMessageBox( this, msg, _("海图软件信息"), wxICON_INFORMATION | wxOK );
...
void RouteManagerDialog::TrackToRoute( Track *track )
{
    ...
    wxProgressDialog *pprog = new wxProgressDialog( _("转化航迹为航线...."),
            _("处理航点..."), 101, NULL,
...
void RouteManagerDialog::WptShowPropertiesDialog( RoutePoint* wp, wxWindow* parent )
{
    ...
    if( wp->m_bIsInLayer ) {
        ...
        pMarkPropDialog->SetDialogTitle( _("航点属性") );
    ...
    if( busy ) {
        for(unsigned int i=0 ; i < list.GetCount() ; i++) {
            ...
            if( wp ) {
                ...
                {
                    if ( wxYES == OCPNMessageBox(this,  _( "你所选中的航点在航线中，是否删除" ), _( "海图警告" ), wxYES_NO ))
...
void RouteManagerDialog::OnWptDeleteAllClick( wxCommandEvent &event )
{
    ...
    int answer = OCPNMessageBox( this, prompt, wxString( _("警告") ), buttons );
    if ( answer == wxID_YES )
...
void RouteManagerDialog::OnLayDeleteClick( wxCommandEvent &event )
{
    ...
    int answer = OCPNMessageBox( this, prompt, wxString( _("警告") ), wxYES_NO );
    if ( answer == wxID_NO )
        return;
