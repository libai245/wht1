...
//    SetMinSize( wxSize(400,240));
    ...
    m_pListCtrlAISTargets->InsertColumn( tlTRK, _("Trk"), wxLIST_FORMAT_LEFT, width );//trk字符在左对齐
    ...
    m_pButtonInfo = new wxButton( this, wxID_ANY, _("目标信息"), wxDefaultPosition,
    ...
    m_pButtonJumpTo = new wxButton( this, wxID_ANY, _("中心视图"), wxDefaultPosition,
            wxDefaultSize, wxBU_AUTODRAW );
    ...
    m_pButtonHideAllTracks = new wxButton( this, wxID_ANY, _("隐藏所有航迹"), wxDefaultPosition,
            wxDefaultSize, wxBU_AUTODRAW );
    ...
    m_pButtonShowAllTracks = new wxButton( this, wxID_ANY, _("显示所有航迹"), wxDefaultPosition,
            wxDefaultSize, wxBU_AUTODRAW );
    ...
    m_pButtonToggleTrack = new wxButton( this, wxID_ANY, _("固定航迹"), wxDefaultPosition,
            wxDefaultSize, wxBU_AUTODRAW );
    ...
    boxSizer02->AddSpacer( 10 );
    m_pStaticTextCount = new wxStaticText( this, wxID_ANY, _("目标数目"), wxDefaultPosition,
            wxDefaultSize, 0 );
