...
#LangString LangDialog_Title ${LANG_ENGLISH} "OpenCPN 3.3.2424 Installation"
LangString LangDialog_Title ${LANG_CZECH} "Instalace OpenCPN 3.3.2424"
...
#LangString Uninstall_Link ${LANG_ENGLISH} "Uninstall OpenCPN 3.3.2424"
LangString Uninstall_Link ${LANG_CZECH} "Odinstalovat OpenCPN 3.3.2424"
...
#LangString Page_TypeInst_Subtitle_Exists ${LANG_ENGLISH} "OpenCPN 3.3.2424 is already installed.$\r$\nChoose how you want to install OpenCPN."
LangString Page_TypeInst_Subtitle_Exists ${LANG_CZECH} "OpenCPN 3.3.2424 je již nainstalováno.$\r$\nVyberte, jak chcete OpenCPN nainstalovat."

#LangString Label_TypeInst_Reinstall_Text ${LANG_ENGLISH} "OpenCPN 3.3.2424 is already installed on your system. You can reinstall the version now using the previous settings. If you wish to install the program with different settings, cancel installation and un-install the existing version first. Click Next to continue."
LangString Label_TypeInst_Reinstall_Text ${LANG_CZECH} "OpenCPN 3.3.2424 je již na Vašem systému nainstalováno. Nyní můžete přeinstalovat verzi s původní nastavením. Pokud chcete nainstalovat program s jiným nastavením, zrušte instalaci a odinstalujte napřed původní verzi. Klikněte na Další pro pokračování."
...
#LangString Finish_Link_URL ${LANG_ENGLISH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2424"
LangString Finish_Link_URL ${LANG_CZECH} "http://opencpn.info/?ref=installer&user=$USERS_NAME&lang=$REG_LANG&version=3.3.2424"
...
;added on 2011-06-13
#LangString ^NameDA ${LANG_ENGLISH} "OpenCPN Version 3.3.2424"
LangString ^NameDA ${LANG_CZECH} "OpenCPN Verze 3.3.2424"
